					...
					<tbody>
						...
						?>
									...
									<tr>
										...
										<td>
											<center><?php echo $rows['alamat']; ?></center>
										</td>
										<td>
											<center>
												<a style="background-color:#0da6b9;" class="btn btn-warning btn-sm" href='include/detail_pendaftaran.php?id_user=<?= $rows['id_user'] ?>'>Lihat</a>
											</center>
