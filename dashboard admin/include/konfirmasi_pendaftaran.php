				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<td>
								<center><b>Nama Pendaftar</b></center>
							</td>
							<td>
								<center><b>Email</b></center>
							</td>
							<td>
								<center><b>Status Pendaftaran</b></center>
							</td>
							<td>
					...
					<tbody>
						...
						?>
									...
									<tr>
										...
										<td>
											<center><?php echo $rows['nama']; ?></center>
										</td>
										<td>
											<center><?php echo $rows['email']; ?></center>
										</td>
										<td>
											<center><?php
													$status == 0 ?
										...
										<td>
											<center>
												...
												<a style="background-color:green;" href='include/proses_konfirmasi_diterima.php?id_user=<?php echo $rows['id_user'] ?>' class="btn btn-warning btn-sm">Diterima</a>
												<a style="background-color:orange;" href='include/proses_konfirmasi_cadangan.php?id_user=<?php echo $rows['id_user'] ?>' class="btn btn-warning btn-sm">Cadangan</a>
												<a style="background-color:red;" href='include/proses_konfirmasi_gagal.php?id_user=<?php echo $rows['id_user'] ?>' class="btn btn-warning btn-sm">Tidak Diterima</a>
											</center>
										</td>
									</tr>
