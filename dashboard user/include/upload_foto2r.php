...
if (isset($_POST['upload'])) {
    $targetfolderBase   = "../dashboard admin/include/uploads/";
    ...
    if ($file_type=="application/pdf" || $file_type=="image/png" || $file_type=="image/jpeg") {
...

         {
            ...
            $query  = "UPDATE pendaftaran SET upload_Rapor='$fileNameAkte' WHERE id=$id";
            ...
            if ($exec) {
             echo "<div class='alert alert-success alert-dismissable'>
              ...
              <strong>Berhasil!</strong> Upload Rapor(PDF, JPEG, PNG).
            </div>";   
            }
         ...
         echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Rapor(PDF, JPEG, PNG).
        </div>";
     ...
     echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Rapor harus format(.PDF, JPEG, PNG).
        </div>";
    ...
    if ($file_type2=="application/pdf" || $file_type2=="image/png" || $file_type2=="image/jpeg") {
        if(move_uploaded_file($_FILES['foto2r']['tmp_name'], $targetfolder2))

         {
            ...
            $query  = "UPDATE pendaftaran SET upload_piagam_prestasi='$fileNameFoto' WHERE id=$id";
            ...
            if ($exec) {
                echo "<div class='alert alert-success alert-dismissable'>
                  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                  <strong>Berhasil!</strong> Upload Piagam Prestasi(PDF, JPEG, PNG).
                </div>";                
            }
         ...
         echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Piagam Prestasi(PDF, JPEG, PNG).
        </div>";
        ...
        echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Piagam Prestasi harus format(PDF, JPEG, PNG).
        </div>";
    }
    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Upload Rapor(PDF, JPEG, PNG) dan Piagam Prestasi(PDF, JPEG, PNG)</h4>
            ...
            <div class="card-content">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group floating-label" style="margin-left: 20px;">
                            <label class="col-sm-12">Piagam Prestasi (PDF, JPEG, PNG) : </label>
                            <label class="btn btn-primary" for="my-file-selector2">
                                ...
                                Upload Piagam Prestasi (PDF, JPEG, PNG)
                            </label>
